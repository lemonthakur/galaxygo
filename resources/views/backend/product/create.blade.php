                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control {{$errors->has("quantity") ? "is-invalid":""}}" id="quantity" name="quantity" placeholder="Enter quantity" value="{{old("quantity")}}" required>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" step="any" class="form-control {{$errors->has("deliver_charge") ? "is-invalid":""}}" id="deliver_charge" name="deliver_charge" placeholder="Enter deliver charge" value="{{old("deliver_charge")}}" required>
